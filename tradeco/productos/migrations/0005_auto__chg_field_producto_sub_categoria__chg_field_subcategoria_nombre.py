...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'productos_producto', 'sub_categoria_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['productos.SubCategoria'], null=True))

        # Changing field 'SubCategoria.nombre'
        db.alter_column(u'productos_subcategoria', 'nombre', self.gf('django.db.models.fields.CharField')(default=1, max_length=100))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Producto.sub_categoria'
        raise RuntimeError("Cannot reverse this migration. 'Producto.sub_categoria' and its values cannot be restored.")
